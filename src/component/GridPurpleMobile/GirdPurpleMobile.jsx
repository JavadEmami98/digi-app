...
import CartPurple from "../GridPurple/CartPurple";
...
function GirdPurpleMobile() {
  return (
    <div>
      <Box sx={{ flexGrow: 1 }}>
        <Grid container spacing={0} sx={{ padding: "25px 20px" }}>
          {cardpurple.map((item, index) => (
            <Grid item md={3} xs={4} sm={4} key={index}>
...
export default GirdPurpleMobile;
